...
var guiTabs = (function(self) {
	...
	return {valid: max - prev, possible: max - derived.snapshot[0], firstValid: prev};
    }
	...
	document.getElementById('inGiftHistoryValid').innerHTML
	    = guiString('inGiftHistoryValid', [ Math.floor(validDays), Math.floor(possibleDays) ]);
    }	
