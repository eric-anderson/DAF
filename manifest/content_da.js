/*
** DA Friends - content_da.js - THANKS Vins, for the script
*/
...
function _daf_content_da(e)
{
   ...
   (function() {
     ...
     var isFullwindow = false, miner, btn, refresh, onResize, iframe, originalHeight;
      isFullwindow = GM_getValue("daFullWindow", "0") !== "0";    // !== "1" ? "0" : "1";
     ...
     if(miner) { // inner IFRAME has a "miner" object
         ...
         refresh = function() {
             ...
             iterate(document.getElementsByClassName("news"), function(el) { if(el && el.style) { el.style.position = isFullwindow ? "fixed" : ""; } });
